...
{
    public partial class kalumnotasdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Carne = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Alumnos", x => x.Carne);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrerasTecnicas", x => x.CarreraId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HorarioId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreSalon = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClaseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HorarioId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clases", x => x.ClaseId);
                    table.ForeignKey(
                        name: "FK_Clases_CarrerasTecnicas_CarreraId",
            ...
            migrationBuilder.CreateTable(
                name: "AsignacionesAlumnos",
                columns: table => new
                {
                    AsignacionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Carne = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClaseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionesAlumnos", x => x.AsignacionId);
                    table.ForeignKey(
                        name: "FK_AsignacionesAlumnos_Alumnos_Carne",
                        column: x => x.Carne,
                        principalTable: "Alumnos",
                        principalColumn: "Carne",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AsignacionesAlumnos_Clases_ClaseId",
                        column: x => x.ClaseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesAlumnos_Carne",
                table: "AsignacionesAlumnos",
                column: "Carne");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesAlumnos_ClaseId",
                table: "AsignacionesAlumnos",
                column: "ClaseId");
